...
#官方划分 训练集 23,929 测试集 24,633  没有验证集划分

# images.txt - 图像路径映射文件   1 0001/Ruby_throated_Hummingbird_0001_58549.jpg   图像ID  图像路径
#image_class_labels.txt - 图像类别标签文件  1 542    图像ID 类别ID
# train_test_split.txt - 训练/测试划分文件   1 1  图像ID 训练/测试 1表示训练集 0表示测试集
#classes.txt - 类别名称文件     1 Black_footed_Albatross
# hierarchy.txt - 类别层次结构文件
